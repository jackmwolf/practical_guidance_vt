...
cd $path
module load R/3.6.0
eval "R CMD BATCH --no-save --no-restore '--args g0=\"$g0\" h0=\"$h0\" f0=$f0 sims=$sims c_name=\"$c_name\"' $path/../Scripts/Rcode/Cond_Chuyu.R $path/Logfiles/$c_name.job$SLURM_ARRAY_TASK_ID.txt"
